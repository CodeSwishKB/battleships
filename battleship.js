var missedSound = new Audio("sounds/missed_1sec.mp3")
var hitSound = new Audio("sounds/hit_2sec.wav")
var alertSound = new Audio("sounds/classic-alarm.wav")
var clapSound = new Audio("sounds/applause.wav")
    ...
    fire: function (guess) {
        for (var i = 0; i < this.numShips; i++) {
            ...
            if (ship.hits[index] === "hit"){
                view.displayMessage("Oops you hit that location already")
                missedSound.play();
            }
            else if (index >= 0) {
                // We have a hit
    ...
    processGuess: function (guess) {
        ...
        if (location) {
            ...
            if (hit && model.shipSunks === model.numShips) {
                view.displayMessage(`Congrats! You sank all my battleships, in ${this.guesses} guesses`)
                clapSound.play();
            }
        }
    }
